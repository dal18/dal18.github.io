...
<head>
    ...
    <title>Feedback Management - LFHS</title>
        ...
        <header class="sticky top-0 z-40 glass-card shadow-lg border-b border-gray-200">
            <div class="flex items-center justify-between px-6 py-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">View and manage user feedback</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-blue">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Total Feedback</p>
                            <p class="text-4xl font-bold" id="totalFeedback">0</p>
                        </div>
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-green">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">This Week</p>
                            <p class="text-4xl font-bold" id="weekFeedback">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-purple">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Positive</p>
                            <p class="text-4xl font-bold" id="positiveFeedback">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-orange">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Pending Review</p>
                            <p class="text-4xl font-bold" id="pendingFeedback">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div id="feedback_page">
                    ...
                    <div class="flex items-center justify-center py-20">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600 font-medium">Loading feedback...</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        function updateStats() {
            ...
            $({countNum: 0}).animate({countNum: total}, {
                ...
                easing: 'swing',
                step: function() {
                    $('#totalFeedback').text(Math.floor(this.countNum));
                },
                complete: function() {
