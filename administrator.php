...
<head>
    ...
    <title>Administrator Management - LFHS</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    ...
    <div class="transition-all duration-300 md:ml-64" id="mainContent">
        ...
        <header class="sticky top-0 z-40 glass-card shadow-lg border-b border-gray-200">
            <div class="flex items-center justify-between px-6 py-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Manage system administrators and access rights</p>
                </div>
                ...
                <div class="relative">
                    ...
                    <div id="profileDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-200 hidden animate-slide-in">
                        <a href="profile.php" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 rounded-t-xl transition-colors">
        ...
        <main class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-blue">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Total Administrators</p>
                            <p class="text-4xl font-bold" id="totalAdmins">0</p>
                        </div>
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-green">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Active Admins</p>
                            <p class="text-4xl font-bold" id="activeAdmins">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-purple">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Super Admins</p>
                            <p class="text-4xl font-bold" id="superAdmins">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div class="hover-lift rounded-2xl p-6 text-white shadow-xl gradient-orange">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium opacity-90 mb-1">Added This Month</p>
                            <p class="text-4xl font-bold" id="recentAdmins">0</p>
                        </div>
                        <div class="bg-white/20 p-4 rounded-xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-5">
                        ...
                        <input type="text"
                               ...
                               class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all">
                    </div>

                    <div class="md:col-span-3">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-filter text-gray-400 mr-2"></i>Records Per Page
                        </label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-calendar text-gray-400 mr-2"></i>Date Filter
                        </label>
                        <input type="text"
                               id="date_filter"
                    ...
                    <div class="md:col-span-2 flex items-end">
                        <button id="add_admin" class="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-emerald-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="glass-card rounded-2xl shadow-lg overflow-hidden">
                <div id="administrator_page">
                    <!-- Content loaded via AJAX -->
                    <div class="flex items-center justify-center py-20">
                        <div class="text-center">
                            <i class="fas fa-spinner fa-spin text-5xl text-blue-500 mb-4"></i>
                            <p class="text-gray-600 font-medium">Loading administrators...</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="customModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl animate-scale-in">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-purple-600 rounded-t-2xl">
                ...
                <button id="closeModal" class="text-white hover:bg-white/20 rounded-lg p-2 transition-all">
    ...
    $(document).ready(function() {
        ...
        function load(keyword, perpage, page, date_filter) {
            $.ajax({
                type: 'post',
                url: 'php/read_administrator.php',
                data: {
                    keyword: keyword,
                    perpage: perpage,
                    page: page,
        ...
        function updateStats() {
            ...
            $({countNum: 0}).animate({countNum: total}, {
                ...
                easing: 'swing',
                step: function() {
                    $('#totalAdmins').text(Math.floor(this.countNum));
                },
                complete: function() {
        ...
        $(document).on('keyup', '#keyword', function() {
            ...
            searchTimeout = setTimeout(() => {
                load($(this).val(), $("#perpage").val(), 1, $("#date_filter").val());
            }, 500);
        });

        // Change per page
        $(document).on('change', '#perpage', function() {
            load($("#keyword").val(), $(this).val(), 1, $("#date_filter").val());
        });
        ...
        $(document).on('click', '.page-link', function(e) {
            ...
            if (page) {
                load($("#keyword").val(), $("#perpage").val(), page, $("#date_filter").val());
        ...
        $(document).on('click', '#add_admin', function() {
            $("#modalTitle").html('<i class="fas fa-plus mr-2"></i>Add Administrator');
            $("#modalBody").load('php/add_admin.php');
